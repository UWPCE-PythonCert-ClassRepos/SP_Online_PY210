...
- Changed some code to use Comprehensions.
"""
...
# note: the key for the enclosing dict should not be 0 or it will
# mess up functions below # (since 0 is equivalent to False)
donor_db = {1: ({"first_name": "Dee", "last_name": "Zaster", 
                "donations": [10000.00, 1500.00]}),
            2: ({"first_name": "Owen", "last_name": "Money", 
                "donations": [7000.00]}),
            3: ({"first_name": "Shanda", "last_name": "Lear", 
                "donations": [100.00, 900.00, 1500.00]}),
            4: ({"first_name": "Joe", "last_name": "King", 
                "donations": [500.00, 700.00, 500.00]}),
            5: ({"first_name": "Artie", "last_name": "Choke", 

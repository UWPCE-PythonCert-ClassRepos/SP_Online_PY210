...
# ------------------------------------------------------------------------------ #
# Title: Exercise 5 - Exceptions (graded)
# Description: Exercise 5 - Exceptions (graded) from Lesson05
# ChangeLog (Who,When,What):
# Mercedes Gonzalez Gonzalez,01-22-2021, Created Exceptions Exercise Script
# ------------------------------------------------------------------------------ #

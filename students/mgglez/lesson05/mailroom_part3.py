...
# ------------------------------------------------------------------------------ #
# Title: Lesson05 - Assignment 3 - Mailroom Part 3
# Description: Assignment from Lesson05 - Mailroom Part 3 (Graded)
# ChangeLog (Who,When,What):
# Mercedes Gonzalez Gonzalez,01-22-2021, Created Mailroom Part 3 Script
# ------------------------------------------------------------------------------ #
import os

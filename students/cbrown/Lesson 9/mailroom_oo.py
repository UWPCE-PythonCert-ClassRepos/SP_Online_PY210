...
class DonorCollection():
    ...
    def __init__(self):
        ...
        self.donor_dict = {"Bill Gates": [539000, 235642],
    ...
    def update_donor(self, donor):
        self.donor_dict.get(donor.name).append(donor.amount)

    def add_donor(self, donor):
        self.donor_dict[donor.name] = [donor.amount]
...
def donor_verify(donor):
    '''
    Checks to see if the requested donor is in the DonorCollection dict. Updates new

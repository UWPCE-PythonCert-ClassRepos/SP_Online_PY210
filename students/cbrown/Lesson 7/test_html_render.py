...
def test_attributes():
    e = P("A paragraph of text", style="text_align: center", id="intro")
    ...
    assert file_contents.endswith("</p>")
    assert file_contents.startswith("<p ")
    assert 'style="text_align: center"' in file_contents
...
def test_unordered_list():
    l = Ul(id="TheList", style="line-height:200%")
...
def test_element_indent1():
    ...
    we are expecting to look like this:

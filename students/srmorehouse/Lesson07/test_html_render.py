...
def test_anchor_with_class():
    d = {'class': 'anchor'}
    a = A("http://google.com", "link to google", **d)
    file_contents = render_result(a).strip()
    print(file_contents)
    assert file_contents == '<a class="anchor" href="http://google.com">link to google</a>'
...
def test_h1():
    ...
    file_contents = render_result(e).strip()
    print(file_contents)
    assert("<h1>content</h1>") in file_contents
...
def test_h2():
    ...
    file_contents = render_result(e).strip()
    print(file_contents)
    assert("<h2>content</h2>") in file_contents


def test_h3():
    e = H(3, "content", id="content")
    file_contents = render_result(e).strip()
    print(file_contents)
    assert('<h3 id="content">content</h3>') in file_contents

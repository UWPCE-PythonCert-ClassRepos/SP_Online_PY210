...
def fibonacci(n=5):
    """Returns the correlating value of the parameter-passed index position in the Fibonacci series."""
...
def lucas(n):
    """Returns the correlating value of the parameter-passed index position in the Lucas series"""
...
def sum_series(series_element_to_print, first=0, second=1):
    """Returns the correlating value of the parameter-passed index position in a series.

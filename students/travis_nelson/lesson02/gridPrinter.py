...
def print_grid(lengthOfCell=2):
    ...
    def grid_columns(lengthOfCell):
        """Prints the horizontal borders of the grid. The length of these
        borders is specified by the input parameter
        """
        print('+', end=' ')
...
def print_grid2(rowsAndColumnsLength=2, lengthOfCell=2):
    """Prints a grid of variable dimensions,
    as specified by the two int parameters
    """
    def createGridRowsBorder(rowsAndColumnsLength, lengthOfCell):
        ...
        print('+ ', end='')
        for _ in range(rowsAndColumnsLength):
            print('- '*lengthOfCell, end='+ ')

    def createGridColumnsBorder(rowsAndColumnsLength, lengthOfCell):
        """Prints a column line of user input length and cell size"""
        print('|', end='')
        for _ in range(rowsAndColumnsLength):
            print(' '*(lengthOfCell*2), end=' |')

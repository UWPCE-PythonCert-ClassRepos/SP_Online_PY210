...
a_str = "file_{:03d} :    {:.2f}, {:.2e}, {:3.2e}".format(a_tuple[0],a_tuple[1],a_tuple[2],a_tuple[3])
print(a_str)

# ---- Task 2 ----
b_str = f"file_{a_tuple[0]:03d} :    {a_tuple[1]:.2f}, {a_tuple[2]:.2e}, {a_tuple[3]:3.2e}"
print(b_str)
...
d_str = "{:02d} {:02d} {:d} {:02d} {:02d}".format(b_tuple[-2], b_tuple[-1], b_tuple[2], b_tuple[0], b_tuple[1])
print(d_str)
...
d_str = f"The weight of an {in_list[0][:-1]} is {in_list[1]} and the weight of a {in_list[2][:-1]} is {in_list[3]}"
print(d_str)
e_str = f"The weight of an {in_list[0][:-1].upper()} is {in_list[1]*1.2} and the weight of a {in_list[2][:-1].upper()} is {in_list[3]*1.2}"
print(e_str)

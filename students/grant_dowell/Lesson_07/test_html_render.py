...
def test_anchor():
    link = A("http://google.com", "link to google")
    file_contents = render_result(link)
    print(file_contents)
    assert file_contents == '<a href="http://google.com">link to google</a>\n'
    
def test_list():
    unordered_list = Ul()
    file_contents = render_result(unordered_list).strip()
    print(file_contents)
...
def test_list_item():
    item = Li()
    file_contents = render_result(item).strip()
    print(file_contents)
...
def test_one_line_indent():
    
    e = OneLineTag('Some Content')
    file_contents = render_result

def test_OneLine_indent():
    """ Tests that OneLineTags are properly indented"""

    html = OneLineTag("some content")
    file_contents = render_result(html, ind="   ").rstrip()  #remove the end newline
...
def test_SelfClosingTag_indent():
    """ Tests that SelfClosing Tags are properly indented"""

    html = SelfClosingTag("some content")
    file_contents = render_result(html, ind="   ").rstrip()  #remove the end newline

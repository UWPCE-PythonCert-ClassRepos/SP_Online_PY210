...
def test_render_element():
    ...
    # making sure there are only one opening and closing tags
...
def test_Title():
    """
    tests the OneLineTag
    """
    e = Title("some plain text.")

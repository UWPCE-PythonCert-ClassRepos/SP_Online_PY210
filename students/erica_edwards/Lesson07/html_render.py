    ...
    def render(self, out_file, ind=""):
        ...
        for content in self.contents:
            ...
            if hasattr(content, 'render'):
                content.render(out_file, ind=self.indent + ind)        # new      # Indent -> pass
            else:
                out_file.write(f'{self.indent + ind}{content}\n')  # old      # Indent 
            #out_file.write("\n")
        out_file.write(f'{ind}')                                # Indent
...
#     def __init__(self, doc_type, content=None, **kwargs):
#         kwargs['doc_type'] = doc_type
#         super().__init__(content, **kwargs)
    
#     def _open_tag(self):
#         open_tag = f"<{self.tag} {self.attributes['doc_type']}>"
#         return open_tag
...
class OneLineTag(Element):
    def render(self, out_file, ind=""):
        out_file.write(ind)
        out_file.write(self._open_tag())
        # out_file.write(self.indent + ind)

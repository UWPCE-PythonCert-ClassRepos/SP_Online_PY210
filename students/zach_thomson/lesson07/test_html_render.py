...
def test_render_element():
    ...
    #make sure there is only one instance of html at beginning and at end
...
def test_OneLineTag_append():
    '''
    You should not be able to append to OneLineTag
    '''
    e = OneLineTag('this is some content')
    with pytest.raises(NotImplementedError):
        e.append('this is some appended content')

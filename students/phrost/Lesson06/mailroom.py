...
def get_donor_db():
    return {'Jimmy Hendrix': ("Jimmy Hendrix", [23.23, 24.48]),
            'Jack White': ("Jack White", [32.84, 48]), 
            'Keith Richards':("Keith Richards",[68]),
            'Jimmy Page': ("Jimmy Page", [34, 89]),
            'Albert Hamond': ("Albert Hamond",[34, 64, 49])
            }

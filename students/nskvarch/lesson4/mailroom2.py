...
def run_report(donor_db):
    """take in the donor database, create organize and sort a table in the form of a list and then hand the table off to the printer function"""
    data_lines = []
...
def print_thankyou(donor_db, donor_name):
    """Takes in the name and donation ammount and organizes the valuses into a sample thank you letter and displays it on the screen"""
    nl = "\n"

...
class test_case_three(unittest.TestCase):
    ...
    def test_one_line_tag_append(self):
        """
...
class test_case_seven(unittest.TestCase):
    def test_li(self):
        li = Li("some content")
...
class test_case_eight(unittest.TestCase):
    def test_meta(self):
...
class test_case_nine(unittest.TestCase):

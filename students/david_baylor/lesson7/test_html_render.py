...
def test_attributes():
    ...
    assert file_contents.endswith("</p>")
    assert file_contents.startswith('<p style="text-align: center" id="intro">')

def test_attributes_one_line_tag():
    e = Title("A title", style="text-align: center", id="intro")
    file_contents = render_result(e).strip()
    assert "A title" in file_contents
    assert file_contents.endswith("</title>")
    assert file_contents.startswith('<title style="text-align: center" id="intro">')
...
def test_Ul_and_Li():
    ...
    e.append(Li("The first item in a list"))
    e.append(Li("This is the second item", style="color: red"))
    file_contents = render_result(e).strip()

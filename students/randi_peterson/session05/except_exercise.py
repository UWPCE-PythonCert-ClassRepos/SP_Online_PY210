...
#Try more_fun with first language
try:
    more_joke = more_fun(langs[0])
except IndexError:
    #Print used for debugging/to add to the fun...replaced with pass to get desired output shown in exercise spec
    #print('Stop blowing holes in my code!')
    pass

#Try more_fun with second language
try:

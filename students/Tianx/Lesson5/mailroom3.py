    ...
    while True:
        ...
        while True:
            try:
                ...
                response = input('Error: Please enter a number. Please select again >')
        ...
        if donor_name not in dict_of_donors and donor_name != "List" and donor_name != "Exit":
            ...
            while True:
                try:
                    ...
                    response = input('Error: Please enter a number for the donation amount>')
            donation_amount = response # Convert the amount into a number

...
# <07/08/2020>, mailroom part 4, Unit Testing, refactor code
# ---------------------------------------------------------------------------- #
# imports
import sys
...
def donor_list():
    '''print sorted donor list'''
    donor_sort = (sorted(donor_info.keys()))  # used .keys() to sort on key
    for key in donor_sort:
        print(key)


def exist_donor(donor_name, donor_amount):
    '''If donor name existing in registry append donation amount to name'''
    donor_info[donor_name].append(donor_amount)
    return donor_info


def new_donor_add(donor_name, donor_amount):
    '''If donor is new to registry add name and donation amount'''
    ...
    while True:
        ...
        if donor_name == "": # error handling
            ...
            if donor_info.get(donor_name):
                exist_donor(donor_name, donor_amount)
            ...
            # if name not in list add new name to donor info list
                ...
                new_donor_add(donor_name, donor_amount)
...
def report_generator():
    '''This is all the guts of the report'''

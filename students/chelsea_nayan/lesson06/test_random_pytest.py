...
import random # imported because that is what we are testing
import pytest # imported since we are using its utilities

# Create a little seq used for testing
example_seq = list(range(10))

# Simply by naming "test_something", pytest will run it as a test
def test_choice():
    """

...
def test_lists():
    unordered_list = Ul(style="line-height:200%", id="TheList")
    unordered_list.append(Li("This is the first list."))
    unordered_list.append(Li("This is the second list."))
    file_contents = render_result(unordered_list)
...
def test_header():
    section_header = H(2, "PythonClass - Class 6 example")
    file_contents = render_result(section_header)
    print(file_contents)

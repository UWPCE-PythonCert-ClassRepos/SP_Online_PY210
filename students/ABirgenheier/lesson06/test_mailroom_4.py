...
def test_list_of_donars():
    ...
    donars_list = ('Mike\nTony\nSarah')
    assert mailroom4.list_of_donars() == donars_list


def test_donations():
    """ Test donor name and donation amount update """
    mailroom4.donations('Mike', 200)
    assert mailroom4.donars_data.get('Mike') == [200]
...
def test_thank_you_message():
    ...
    assert mailroom4.thank_you_message('Mike') == message

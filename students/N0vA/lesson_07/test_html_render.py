...
def test_li():
    ...
    e = Li("This is an item")
    file_contents = render_result(e)

    assert("This is an item") in file_contents
    print(file_contents)
...
def ul():
    ...
    e = Ul("This is another item")
    file_contents = render_result(e)

    assert("This is another item") in file_contents
    print(file_contents)
...
def test_header():
    ...
    e = Header(1, 'Python Header')
    file_contents = render_result(e)
    print(file_contents)

    assert '<header1>Python Header</header1>' in file_contents
    assert file_contents.startswith('<header1')
    assert file_contents.endswith('</header1>\n')
    

def test_header2():
    e = Header(2, 'Second Python Header')
    file_contents = render_result(e)
    print(file_contents)

    assert '<header2>Second Python Header</header2>' in file_contents
    assert file_contents.startswith('<header2')
    assert file_contents.endswith('</header2>\n')

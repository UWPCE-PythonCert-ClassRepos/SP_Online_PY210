...
def test_link_A():
    A_test = A("http://google.com", "link to google")
    a = render_result(A_test)
    print(a)
    assert a == f'<a href="http://google.com">link to google</a>\n'
...
def test_unordered():
    l1 = Li('test material', attribute = 'bullet')
    l2 = Li('more test material', attribute = 'bold')
    ul = Ul(thing = "blue")
    ul.append(H(1, 'Big List'))
    ul.append(l1)
    ul.append(l2)

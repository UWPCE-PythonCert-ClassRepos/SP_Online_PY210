...
page.append("And here is another piece of text -- you should " +
            "be able to add any number")
...
body.append(hr.P("And here is another piece of text --"
...
page.append(head)
body = hr.Body()
body.append(hr.P("Testing SelfClosingTag"))
body.append(hr.Hr(width='400'))
print(f"Here before")
try:
    body.append(hr.Hr("Try to put content for selfclosing tag", width='800'))
except TypeError:
    print("There is no content for SelfClosingTag.")
    sys.exit()

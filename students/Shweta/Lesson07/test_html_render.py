...
def test_head():
#    """
#    tests tha head element is there or not
#    """
     h=Head()
     h.append("A simple heah of text")
     file_contents=render_result(h).strip()
     print(file_contents)
     assert "A simple heah of text" in file_contents
...
def test_anchor():
    ...
    file_content=render_result(a)
    print(file_content)
    assert file_content.startswith('<a ')

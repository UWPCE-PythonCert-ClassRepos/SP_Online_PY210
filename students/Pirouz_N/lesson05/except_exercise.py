...
try:
    ...
    name_error.extra_info = 'Please use a variable after definition is complete.'
...
try:
    ...
    er.extra_info = 'Please make sure the index given to List is not largere than len(List) - 1'
    try:

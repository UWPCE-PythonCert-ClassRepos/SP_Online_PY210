...
ap = hr.P("Here is a paragraph of text -- there could be more of them",
          style="text-align: center; font-style: oblique;")
ap.append("but this is enough  to show that we can do some text")
ap.append("More Text!")
ap.append("Some more Text!")

bp = hr.P("Here is a paragraph of text -- there could be more of them",
          style="text-align: center; font-style: oblique;")
bp.append("but this is enough  to show that we can do some text")
bp.append("More Text!")
bp.append("Some more Text!")
ap.append(hr.Hr())
ap.append(hr.H(3, "Some Heading"))
ap.append(bp)
ap.append(hr.Hr())
ap.append(hr.H(3, "Some Heading"))
ap.append(bp)

...
def test_li():
    l1 = Li("The first item in a list")
    file_contents = render_result(l1)
    print(file_contents)
    assert file_contents == '<li>\n    The first item in a list\n</li>\n'

    l2 = Li(style="color: red")
    l2.append("This is the second item")
    file_contents = render_result(l2)
    print(file_contents)
    assert file_contents == '<li style="color: red">\n    This is the second item\n</li>\n'

    l3 = Li("And this is a")
    l3.append(A("http://google.com", "link"))
    l3.append("to google")
    file_contents = render_result(l3)
    print(file_contents)

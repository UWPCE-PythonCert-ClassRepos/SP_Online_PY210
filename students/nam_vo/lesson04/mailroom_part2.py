...
def send_single():
    ...
    while name == "list":
        ...
        # Ask for donor's full name
        name = input("Enter donor's full name (or 'list' to list all donor' names): ")
    # Add donor to dictionary if it's new
...
def send_all():
    ...
    for (name, donations) in donor_dict.items():
        ...
        with open(fileName, 'w') as outFile:
            ...
            print(f'File "{fileName}" has been created in current working directory!')
...
def print_donor(donor_dict):
    ...
    """
    # print("\n".join(["{}"]*len(donor_dict))).format(**donor_dict)
    [print(name) for name in donor_dict]

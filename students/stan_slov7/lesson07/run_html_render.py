...
head = hr.Head()
head.append(hr.Title("LINK PythonClass = Revision 1087:"))
...
body.append( hr.A("http://google.com", "new link", style="text-align: center") )
# body.append( hr.A("new link", href="http://google.com", style="text-align: center" ) )
...
head = hr.Head()
head.append(hr.Title("HEADING PythonClass = Revision 1087:"))
...
body.append(hr.P("HEADING Here is a paragraph of text -- there could be more of them, "
                 "but this is enough  to show that we can do some text",
              style="text-align: center; font-style: oblique;"))

...
def test_get_report():
    ...
    row4 = results[3]
    row5 = results[4]
    assert row1 == "Drew Barrymore             $     25000.00             1  $    25000.00"
    assert row2 == "Jack Black                 $     11109.50             3  $     3703.17"
    assert row3 == "Sam Smith                  $      5524.00             2  $     2762.00"
    assert row4 == "Cher                       $      1245.00             2  $      622.50"
